...
router.post('/', auth_1.authenticateToken, async (req, res) => {
    try {
        ...
        const { email, first_name, last_name, middle_name, role, position, department, department_id, manager_id, mattermost_username, password = 'defaultPassword123' } = req.body;
...
router.put('/:id', auth_1.authenticateToken, async (req, res) => {
    try {
        ...
        const { email, first_name, last_name, middle_name, role, position, department, department_id, manager_id, mattermost_username, is_manager } = req.body;
